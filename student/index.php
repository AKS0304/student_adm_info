...
<body class="bg-light">
    ...
    <div class="container mt-5 mb-5">
        <div class="d-flex justify-content-center mt-3">
            <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#admissionFormContainer" aria-expanded="false" aria-controls="admissionFormContainer">
                <i class="bi bi-arrow-90deg-down"></i> Admission Enquiry
            </button>
        </div>
    ...
    <div class="footer">
        <p class="p-1">Designed by Amit. All rights reserved 2024.</p>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            admissionForm.addEventListener('submit', function(e){
                ...
                data.append('full_name', admissionForm.elements['full_name'].value);
                data.append('date_of_birth', admissionForm.elements['date_of_birth'].value);
                data.append('gender', admissionForm.elements['gender'].value);
                data.append('contact_number', admissionForm.elements['contact_number'].value);
                data.append('email', admissionForm.elements['email'].value);
                data.append('perm_street', admissionForm.elements['perm_street'].value);
                data.append('perm_city', admissionForm.elements['perm_city'].value);
                data.append('perm_state', admissionForm.elements['perm_state'].value);
                data.append('perm_postal_code', admissionForm.elements['perm_postal_code'].value);
                data.append('desired_course', admissionForm.elements['desired_course'].value);
                data.append('desired_branch', admissionForm.elements['desired_branch'].value);
                data.append('highest_qualification', admissionForm.elements['highest_qualification'].value);
                data.append('institution_name', admissionForm.elements['institution_name'].value);
                data.append('year_of_passing', admissionForm.elements['year_of_passing'].value);
                data.append('grade', admissionForm.elements['grade'].value);
                data.append('photograph', admissionForm.elements['photograph'].files[0]);
                data.append('register', '');

                $('#admissionFormContainer').collapse('hide');

                let xhr = new XMLHttpRequest();
                xhr.open("POST", "ajax/submit_form.php", true);
